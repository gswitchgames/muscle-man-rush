...
window.zs = window.zs || {}, function(e) {
    ...
    var s = /* */ function() {
        ...
        (0, _createClass2.default)(s, [ {
            ...
            value: function registe() {
                var _this = this;
                // this.fsm = new zs.fsm().registe(s.PRODUCT_START, s.PRODUCT_BEGIN).
                // registe(s.PRODUCT_BEGIN, s.GAME_HOME).registe(s.GAME_HOME, s.PRODUCT_HOME_PLAY).
                // registe(s.PRODUCT_HOME_PLAY, s.GAME_PLAY).registe(s.GAME_PLAY, s.PRODUCT_PLAY_END).
                // registe(s.PRODUCT_PLAY_END, s.GAME_END).registe(s.GAME_END, s.PRODUCT_FINISH).
                // registe(s.PRODUCT_FINISH, s.PRODUCT_BEGIN).setDefault(s.PRODUCT_START), 
                
                this.fsm = new zs.fsm().registe(s.GAME_HOME,s.GAME_PLAY).registe(s.GAME_PLAY,  s.GAME_HOME).setDefault(s.GAME_HOME), 
    ...
    var i = /* */ function() {
        ...
        (0, _createClass2.default)(i, null, [ {
            ...
            value: function onWorkflow(e, t, s, i) {
                ...
                this.workflow ? this.workflow.on(e, t, s, i) : (t.once = !1, console.error("这里是什么啊"),this.workListeners.push({
                    key: e,
                    handler: t,
                    priority: i,
                    isBefore: s
    ...
    i.loadingPage = null, i.nativeLoadingPage = null, 
    // e.showMsgBox = function(e) {

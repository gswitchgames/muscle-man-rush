...
var _assertThisInitialized2 = _interopRequireDefault(babel_require("../../@babel/runtime/helpers/assertThisInitialized"));

var _get2 = _interopRequireDefault(babel_require("../../@babel/runtime/helpers/get"));

var _possibleConstructorReturn2 = _interopRequireDefault(babel_require("../../@babel/runtime/helpers/possibleConstructorReturn"));

var _getPrototypeOf2 = _interopRequireDefault(babel_require("../../@babel/runtime/helpers/getPrototypeOf"));

var _inherits2 = _interopRequireDefault(babel_require("../../@babel/runtime/helpers/inherits"));

var _regenerator = _interopRequireDefault(babel_require("../../@babel/runtime/regenerator"));

var _asyncToGenerator2 = _interopRequireDefault(babel_require("../../@babel/runtime/helpers/asyncToGenerator"));
        ...
        (0, _createClass2.default)(_class4, [ {
            ...
            value: function onClicked() {
                ...
                t && (this.offsetx || this.offsety)) {
                    ...
                    _this19.ignoreClick = !1;
                }, Number(zs.product.get("zs_button_delay_time"))), this.clickignore = null, this.onFakeClicked()) : this.firstclickignore ? this.isfristclick ? (this.ignoreClick = !1, 
                this.isfristclick = !1) : this.event && zs.core.workflow && zs.core.workflow.runEventConfig(this.event) : (this.clickalways && (this.ignoreClick = !1), 
            ...
            value: function apply() {
                ...
                this.autoFade(), this.isFading = !0), this.isfristclick = !0, this;
            }
        }, {
            key: "applyConfig",
            value: function applyConfig(t) {
                ...
                t.firstclickignore && this.setfirstclickignore(t.firstclickignore)), this.apply();
            }
        }, {
            key: "url",
            get: function get() {

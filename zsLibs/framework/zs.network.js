    ...
    var s = /* */ function() {
        ...
        (0, _createClass2.default)(s, null, [ {
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                              ...
                              case 4:
                                ...
                                _e && (
                                    // _e.webDomains 
                                    // && (s.listDomain = _e.webDomains), 
                                _e.webApis && (_e.webApis.ping && (s.mapWebApi.ping = _e.webApis.ping), 
            ...
            value: function getUrl(t) {
                ...
                // || 
                // s.domainIdx >= s.listDomain.length 
                // ? null : null == s.mapWebApi[t] ? (zs.log.error("非法网络接口： " + t, "Network"), 
                // null) 
                // : 
                // s.listDomain[s.domainIdx] + "/" + s.version + "/" + s.mapWebApi[t];
            }
        }, {
            key: "obj2arg",
